...
<body>
    <header class="w3-container w3-pink w3-center">
        <h1>TABEL PAKTA INTEGRITAS ANNISA</h1>
    </header>
    ...
    <div class="w3-container w3-half w3-margin-top" style="overflow-x:auto;">
        ...
        <tr>
            ...
            <?php
                $no=1;
                $query="SELECT * FROM tbl_ttd_annisa";
            ...
            <tr>
                <td><?php echo $no++; ?></td>
                <td>
                    <img src="signatures/<?php echo $nama; ?>" width="100px">
                    </br>
                    <b><?php echo $row['nama']; ?></b>
                    </br>
                    <b><?php echo $row['nim']; ?></b>
                </td>
                <td><a href="annisasign.php?id=<?php echo $row['id']; ?>">Isi Tanda Tangan</a></td>
            </tr>
            <?php } ?>
        </table>
    </div>
    <a href="annisacetak.php"><div class="w3-panel w3-card"><p class="w3-center">VIEW PDF</p></div></a>
