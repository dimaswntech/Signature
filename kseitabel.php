...
<body>
    <header class="w3-container w3-blue w3-center">
        <h1>TABEL PAKTA INTEGRITAS KSEI</h1>
    </header>
    ...
    <div class="w3-container w3-half w3-margin-top" style="overflow-x:auto;">
        ...
        <tr>
            ...
            <?php
                $no=1;
                $query="SELECT * FROM tbl_ttd_ksei";
            ...
            <tr>
                ...
                <td><a href="kseisign.php?id=<?php echo $row['id']; ?>">Isi Tanda Tangan</a></td>
            </tr>
            <?php } ?>
        </table>
    </div>
    <a href="kseicetak.php"><div class="w3-panel w3-card"><p class="w3-center">VIEW PDF</p></div></a>
