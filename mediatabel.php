...
<body>
    <header class="w3-container w3-blue-gray w3-center">
        <h1>TABEL PAKTA INTEGRITAS MEDIA</h1>
    </header>
    ...
    <div class="w3-container w3-half w3-margin-top" style="overflow-x:auto;">
        ...
        <tr>
            ...
            <?php
                $no=1;
                $query="SELECT * FROM tbl_ttd_media";
            ...
            <tr>
                ...
                <td><a href="mediasign.php?id=<?php echo $row['id']; ?>">Isi Tanda Tangan</a></td>
            </tr>
            <?php } ?>
        </table>
    </div>
    <a href="mediacetak.php"><div class="w3-panel w3-card"><p class="w3-center">VIEW PDF</p></div></a>
