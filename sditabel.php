...
<body>
    <header class="w3-container w3-orange w3-center">
        <h1>TABEL PAKTA INTEGRITAS SDI</h1>
    </header>
    ...
    <div class="w3-container w3-half w3-margin-top" style="overflow-x:auto;">
        ...
        <tr>
            ...
            <tr>
                ...
                <td><a href="sdisign.php?id=<?php echo $row['id']; ?>">Isi Tanda Tangan</a></td>
            </tr>
            <?php } ?>
        </table>
    </div>
    <a href="sdicetak.php"><div class="w3-panel w3-card"><p class="w3-center">VIEW PDF</p></div></a>
